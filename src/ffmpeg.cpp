/*
 * Shamelessly stolen from: https://github.com/tsoding/rendering-video-in-c-with-ffmpeg
*/
...
FFMPEG *ffmpeg_start_rendering(size_t width, size_t height, size_t fps, const uint counter = 0)
{
    ...
    if (child == 0) {
        ...
        int ret = execlp("ffmpeg",
            ...
            "-c:v", "h264", //libx264 was giving me error. The 'h264' uses whatever the default encoder for my system is.
            "-vb", "2500k",
            "-c:a", "aac",
            "-ab", "200k",
            "-pix_fmt", "yuv420p",
